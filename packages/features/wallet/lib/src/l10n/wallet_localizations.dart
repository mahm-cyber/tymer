...
abstract class WalletLocalizations {
  WalletLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());
  ...
  static const LocalizationsDelegate<WalletLocalizations> delegate = _WalletLocalizationsDelegate();
  ...
  /// No description provided for @withdrawalContainerTitle.
  ///
  /// In en, this message translates to:
  /// **'Withdraw'**
  String get withdrawalContainerTitle;

  /// No description provided for @topUpContainerTitle.
  ///
  /// In en, this message translates to:
  /// **'Top Up'**
...
class _WalletLocalizationsDelegate extends LocalizationsDelegate<WalletLocalizations> {
  ...
  Future<WalletLocalizations> load(Locale locale) {
    return SynchronousFuture<WalletLocalizations>(lookupWalletLocalizations(locale));
  }
...
WalletLocalizations lookupWalletLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'ar': return WalletLocalizationsAr();
    case 'en': return WalletLocalizationsEn();
  }
