...
import 'choose_top_up_method_localizations_ar.dart';
import 'choose_top_up_method_localizations_en.dart';

// ignore_for_file: type=lint

/// Callers can lookup localized strings with an instance of ChooseTopUpMethodLocalizations
/// returned by `ChooseTopUpMethodLocalizations.of(context)`.
///
/// Applications need to include `ChooseTopUpMethodLocalizations.delegate()` in their app's
/// `localizationDelegates` list, and the locales they support in the app's
/// `supportedLocales` list. For example:
///
/// ```dart
/// import 'l10n/choose_top_up_method_localizations.dart';
///
/// return MaterialApp(
///   localizationsDelegates: ChooseTopUpMethodLocalizations.localizationsDelegates,
///   supportedLocales: ChooseTopUpMethodLocalizations.supportedLocales,
