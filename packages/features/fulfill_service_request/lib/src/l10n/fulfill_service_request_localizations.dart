...
abstract class FulfillServiceRequestLocalizations {
  ...
  /// No description provided for @cancelSuccessSnackBarMessage.
  ///
  /// In en, this message translates to:
  /// **'Request cancelled successfully'**
  String get cancelSuccessSnackBarMessage;

  /// No description provided for @cancelFailureSnackBarMessage.
  ///
  /// In en, this message translates to:
